...
public class RunnerFetch11 {
    public static void main(String[] args) {
        ...
        session.clear();//session icini temizledi aynisini cagirinca eger clear methodu kullanilmazsa sorgu atmaz
        ...
        System.out.println("************ session.close() sonrasi--> 1 id li Student icin :");
